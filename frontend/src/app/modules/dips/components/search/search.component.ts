...
export class SearchComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @Output() loadMoreDipSuggestions: Subject<boolean> = new Subject<boolean>();
  @Input() loadingDipsSuggestions: boolean = false;
  format: IFormatting[] = [
    {
      pattern: /and\(/gi,
  ...
  @ViewChild('dipsSugestions') dipsSugestions: TemplateRef<any>;
  ...
  onLoadMoreDipSugestions() {
    this.loadMoreDipSuggestions.next();
  }
