Feature: Details view snapshots
  ...
  Scenario: Global Snapshot
    ...
    And The user opens Details view for DIP1
  ...
  Scenario Outline: Specific Snapshot (Mobile)
    ...
    Examples:
      ...
      | Content Table   | div.DipContentOverlayPanelClass | app-details-mobiles-buttons > div > div.iconWrapper | details-view/content-table-mobile  |
  ...
  Scenario Outline: Specific Snapshot (Mobile) (Dark Mode)
    ...
    Examples:
      | name            | selector                        | activator                                           | image                                   |
      | Content Table   | div.DipContentOverlayPanelClass | app-details-mobiles-buttons > div > div.iconWrapper | details-view/content-table-dark-mobile  |
  ...
  Scenario Outline: Specific Snapshot (Mobile) (Spanish)
    ...
    Examples:
      | name            | selector                        | activator                                           | image                                      |
      | Content Table   | div.DipContentOverlayPanelClass | app-details-mobiles-buttons > div > div.iconWrapper | details-view/content-table-spanish-mobile  |
