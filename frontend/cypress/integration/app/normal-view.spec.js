...
function runTests(lang = 'en') {
  it('Should have all columns', () => {
    ...
    cy.get('[data-cy=table-list-dips] > thead > tr > th').each(($th, idx) => {
  ...
  it('Initially should be sorted by #', () => {
    ...
    cy.get('[data-cy=table-list-dips] > tbody > tr[data-cy=search-result] > td:first-child').each(($td, idx) => {
  ...
  it('Testing sorting by Title', () => {
    ...
    cy.get('[data-cy=table-list-dips] > thead > tr > th.mat-column-title .headerContent').click();

    cy.get('[data-cy=table-list-dips] > tbody > tr[data-cy=search-result] > td.mat-column-title').then($titles => {
  ...
  it('Testing sorting by Status', () => {
    ...
    cy.get('[data-cy=table-list-dips] > thead > tr > th.mat-column-status .headerContent').click()

    cy.get('[data-cy=table-list-dips] > tbody > tr[data-cy=search-result] > td.mat-column-status').then($statuses => {
  ...
  it('Should load more DIPs on scroll to bottom', () => {
