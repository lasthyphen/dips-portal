describe('Test Language Change', () => {
  ...
  it('should change language when clicking the switcher (home page)',()=>{
    ...
    subMenus[0] = ['Primer for Authors','The DIPs Framework','Monthly Governance Cycle']
    subMenus[1] = ['Status','Core Units','DIP Sets','Living DIPs','Technical','Processes']
    ...
    subMenusSpanish[0] = ['Intro para Autores','El Framework de DIP','Ciclo de Gobernanza Mensual']
    subMenusSpanish[1] = ['Estado','Core Units','DIP Sets','Propuestas Registrales','Técnicas','Procesos']
  ...
  it('should change language when clicking the switcher (DIP details page)',()=>{
  ...
  it('should change language when clicking the switcher (DIP details page, darkmode)',()=>{
    cy.get('div.darkModeToggler').click()
