...
describe('Special Search', () => {
  ...
  it('should find given status in DIPs list', () => {
    ...
    cy.get('[data-cy=table-list-dips] tr.maker-element-row:not(.maker-expanded-row) td.mat-column-status').each(($row) => {
  ...
  it('Results of an OR inside an AND should have the status and tags entered', () => {
    const testTags = ['dip-set', 'collateral-onboarding'];
