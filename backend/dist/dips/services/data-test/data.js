...
exports.builtOrFilterMock = exports.orQueryMock = exports.builtStatusFilterMock = exports.statusQueryMock = exports.builtTagFilterMock = exports.tagsQueryMock = exports.tagMock = exports.builtNotEqualFilterMock = exports.builtNotContainsFilterMock = exports.builtInArrayFilterMock = exports.builtEqualsFilterMock = exports.builtContainsFilterMock = exports.builtFilterMock = exports.parseMock = exports.searchFieldMock = exports.requestCallBackNotHeaderMock = exports.requestCallBackMock = exports.parseResultMock = exports.dipNameMock = exports.pullRequestMock = exports.metaVarsMock = exports.filtersMock = exports.valueMock = exports.fieldMock = exports.searchMock = exports.languageMock = exports.selectMock = exports.orderMock = exports.pageMock = exports.limitMock = exports.tagsMock_3 = exports.tagsMock_2 = exports.tagsMock_1 = exports.errorDropMock = exports.extraMock = exports.tagsMock = exports.forumLinkMock = exports.typesMock = exports.titleMock = exports.statusMock = exports.replacesMock = exports.votingPortalLinkMock = exports.dependenciesMock = exports.dateRatifiedMock = exports.dateProposedMock = exports.contributorsMock = exports.authorMock = exports.paragraphSummaryMock = exports.dipNumber_2 = exports.dipNumber_1 = void 0;
exports.errorUpdateMock = exports.preambleMock = exports.dipData = exports.dipFile = exports.componentSummary = exports.components = exports.openIssuemock = exports.parseStringMock = exports.markedListMock = exports.sectionNameMock = exports.referenceMock = exports.dipWithoutNameMock = exports.filesGitMock = exports.titleParsed = exports.componentSummaryParsed_1 = exports.componentSummaryParsed = exports.headingOutComponentSummaryParsed = exports.countMock = exports.totalCountMock = exports.edgesMock = exports.mapKeyMock = exports.dipMapMock = exports.gitFileMock = exports.synchronizeDataMock = exports.dipMock = exports.errorReadFileMock = exports.translationMetaVarsMock = exports.readFileResultMock = exports.languageFileNameMock = exports.getLongerFilesResultMock = exports.getFilesResultMock = exports.longerRawResultMock = exports.rawResultMock = exports.hashMock = exports.pullErrorMock = exports.pullMock = exports.cloneMessageMock = exports.insertManyMock = exports.countPullRequestMock = exports.deleteDipresult = exports.proposalMock = exports.fileNameMock = exports.dipSearcheableMock = exports.dipToBeSearcheableMock = exports.builtAndFilterMock = exports.andQueryMock = exports.builtNotStatusFilterMock = exports.notStatusQuery = exports.builtNotTagFilterMock = exports.notTagQueryMock = void 0;
exports.dipFilesMapMock = exports.openIssueBodyMock = exports.openIssueTitleMock = exports.pullRequestsMock = exports.requestGraphql = exports.markedLexerMock = exports.markedMock = exports.smartSearchFieldMock = exports.statusResultMock = exports.tagResultMock = exports.dipData_2 = void 0;
const dips_entity_1 = require("../../entities/dips.entity");
const faker = require("faker");
faker.seed('Data');
exports.dipNumber_1 = faker.datatype.number({ min: 1, max: 10 });
exports.dipNumber_2 = faker.datatype.number({ min: 1, max: 10 });
const filename = `DIP${exports.dipNumber_1}/DIP${exports.dipNumber_1}.md`;
const sentenceSummary = faker.lorem.paragraph();
exports.paragraphSummaryMock = faker.lorem.paragraph();
exports.authorMock = [`${faker.name.firstName()} ${faker.name.lastName()}`, `${faker.name.firstName()} ${faker.name.lastName()}`,];
exports.contributorsMock = [faker.random.word()];
exports.dateProposedMock = faker.date.past('YYYY-MM-DD').toString();
exports.dateRatifiedMock = faker.date.past('YYYY-MM-DD').toString();
exports.dependenciesMock = [faker.random.word()];
exports.votingPortalLinkMock = faker.internet.url();
const dip = exports.dipNumber_1;
exports.replacesMock = faker.random.word();
exports.statusMock = faker.random.arrayElement(['Accepted', 'Rejected', 'RFC']);
exports.titleMock = faker.lorem.paragraph();
exports.typesMock = faker.random.word();
exports.forumLinkMock = faker.random.word();
exports.tagsMock = faker.random.word();
exports.extraMock = faker.random.word();
exports.errorDropMock = faker.lorem.paragraph();
exports.tagsMock_1 = faker.random.word();
exports.tagsMock_2 = faker.random.word();
exports.tagsMock_3 = faker.random.word();
exports.limitMock = faker.datatype.number();
exports.pageMock = faker.datatype.number();
exports.orderMock = faker.random.word();
exports.selectMock = faker.random.word();
exports.languageMock = faker.random.arrayElement([dips_entity_1.Language.English, dips_entity_1.Language.Spanish]);
exports.searchMock = faker.random.word();
exports.fieldMock = faker.random.word();
exports.valueMock = faker.random.word();
exports.filtersMock = {
    contains: [
        {
...
exports.metaVarsMock = [{
        language: exports.languageMock.toString(),
        translations: exports.languageMock.toString(),
    }];
exports.pullRequestMock = {
    name: faker.random.word(),
};
exports.dipNameMock = faker.random.word();
exports.parseResultMock = faker.datatype.boolean();
exports.requestCallBackMock = {
    headers: {
...
exports.requestCallBackNotHeaderMock = {
    headers: {},
    body: {
        field: faker.random.word(),
    },
};
exports.searchFieldMock = faker.random.word();
exports.parseMock = faker.random.word();
exports.builtFilterMock = {
    language: exports.languageMock,
    [exports.fieldMock]: {
        $regex: new RegExp(`${exports.valueMock}`),
        $options: "i",
    },
};
exports.builtContainsFilterMock = {
    [exports.filtersMock.contains[0].field]: {
        $regex: new RegExp(`${exports.filtersMock.contains[0].value}`),
        $options: "i",
    },
};
exports.builtEqualsFilterMock = {
    [exports.filtersMock.equals[0].field]: exports.filtersMock.equals[0].value,
};
exports.builtInArrayFilterMock = {
    [exports.filtersMock.inarray[0].field]: {
        $in: [exports.filtersMock.inarray[0].value[0], exports.filtersMock.inarray[0].value[1]],
    },
};
exports.builtNotContainsFilterMock = {
    [exports.filtersMock.notcontains[0].field]: {
        $not: {
            $regex: new RegExp(`${exports.filtersMock.notcontains[0].value}`),
            $options: "i",
        },
    },
};
exports.builtNotEqualFilterMock = {
    [exports.filtersMock.notequals[0].field]: {
        $ne: exports.filtersMock.notequals[0].value,
    },
};
exports.tagMock = faker.random.word();
exports.tagsQueryMock = {
    type: 'LITERAL',
    name: '#' + exports.tagMock,
};
exports.builtTagFilterMock = {
    tags: {
        $in: [exports.tagMock]
    }
};
exports.statusQueryMock = {
    type: 'LITERAL',
    name: '@' + exports.statusMock,
};
exports.builtStatusFilterMock = {
    status: {
        $regex: new RegExp(exports.statusMock),
        $options: "i",
    },
};
exports.orQueryMock = {
...
exports.builtOrFilterMock = {
    $or: [
        exports.builtTagFilterMock,
        exports.builtStatusFilterMock,
    ],
};
exports.notTagQueryMock = {
    type: 'OPERATION',
    op: 'not',
    left: '#' + exports.tagMock,
};
exports.builtNotTagFilterMock = {
    tags: {
        $nin: [exports.tagMock],
    }
};
exports.notStatusQuery = {
    type: 'OPERATION',
    op: 'not',
    left: '@' + exports.statusMock,
};
exports.builtNotStatusFilterMock = {
    status: {
        $not: {
...
exports.dipToBeSearcheableMock = {
    dipName: exports.dipNameMock,
    filename: faker.random.word(),
    proposal: faker.random.word(),
    title: exports.titleMock,
    sectionsRaw: [faker.random.word()],
};
exports.dipSearcheableMock = Object.assign(Object.assign({}, exports.dipToBeSearcheableMock), { dipName_plain: exports.dipNameMock, filename_plain: exports.dipToBeSearcheableMock.filename, proposal_plain: exports.dipToBeSearcheableMock.proposal, title_plain: exports.titleMock, sectionsRaw_plain: exports.dipToBeSearcheableMock.sectionsRaw });
exports.fileNameMock = faker.random.word();
exports.proposalMock = faker.random.word();
exports.deleteDipresult = {
    n: faker.datatype.number(),
    ok: faker.datatype.number(),
    deletedCount: faker.datatype.number(),
};
exports.countPullRequestMock = faker.datatype.number();
exports.insertManyMock = faker.datatype.boolean();
exports.cloneMessageMock = faker.random.word();
exports.pullMock = {
...
exports.pullErrorMock = faker.random.word();
exports.hashMock = faker.random.word();
exports.rawResultMock = exports.hashMock + ' ' + exports.hashMock + '\t' + exports.fileNameMock + '\t' + exports.fileNameMock + '.md';
exports.longerRawResultMock = faker.random.word() + ' ' + exports.rawResultMock;
exports.getFilesResultMock = [
    {
        filename: exports.fileNameMock + '.md',
        hash: exports.hashMock,
        language: exports.languageMock,
    },
    {
        filename: exports.fileNameMock + '.md',
...
exports.getLongerFilesResultMock = [
    {
        filename: exports.fileNameMock + ' ' + exports.fileNameMock + '.md',
        hash: exports.hashMock,
        language: exports.languageMock,
    },
    {
...
exports.languageFileNameMock = "I18N/" + exports.languageMock + '/';
exports.readFileResultMock = faker.random.word();
exports.translationMetaVarsMock = [{
        language: dips_entity_1.Language.English,
        translations: exports.readFileResultMock,
    }];
exports.errorReadFileMock = faker.random.word();
exports.dipMock = {
    filename: faker.random.word(),
    hash: faker.random.word(),
    language: faker.random.arrayElement([dips_entity_1.Language.English, dips_entity_1.Language.Spanish]),
    file: faker.random.word(),
    _id: faker.datatype.uuid(),
};
exports.synchronizeDataMock = {
    creates: 1,
    deletes: 1,
    updates: 1,
};
exports.gitFileMock = Object.assign(Object.assign({}, exports.dipMock), { language: faker.random.arrayElement([dips_entity_1.Language.English, dips_entity_1.Language.Spanish]) });
exports.dipMapMock = new Map();
exports.mapKeyMock = faker.random.word();
exports.dipMapMock.set(exports.mapKeyMock, exports.gitFileMock);
exports.edgesMock = faker.random.word();
exports.totalCountMock = faker.datatype.number({ min: 2, max: 4 });
exports.countMock = faker.datatype.number({ min: 1, max: exports.totalCountMock - 1 });
exports.headingOutComponentSummaryParsed = `DIP${exports.dipNumber_1}c13 is a Process DIP component that allows the removal of core personnel using a subproposal. [DIP${exports.dipNumber_1}c13](dips/details/DIP${exports.dipNumber_1}#DIP${exports.dipNumber_1}c13 \"smart-Component\") subproposals have the following parameters:`;
exports.componentSummaryParsed = `## Component Summary ${exports.dipNumber_1}\n\n`;
exports.componentSummaryParsed_1 = `[DIP${exports.dipNumber_1}c13: Core Personnel Offboarding](dips/details/DIP${exports.dipNumber_1}#DIP${exports.dipNumber_1}c13 "NON-SMART-LINK")  `
    + `\nA process component that defines the process to remove personnel from the DIP Editor or Governance Facilitator roles.`;
exports.titleParsed = `# DIP${exports.dipNumber_1}: ${exports.titleMock}\n\n`;
exports.filesGitMock = [Object.assign(Object.assign({}, exports.dipMock), { filename })];
exports.dipWithoutNameMock = Object.assign(Object.assign({}, exports.dipMock), { dip: undefined, dipName: undefined });
exports.referenceMock = {
    link: faker.internet.url(),
    name: faker.random.word(),
};
exports.sectionNameMock = `DIP${exports.dipNumber_1}c${faker.datatype.number({ min: 1, max: 30 })}`;
exports.markedListMock = [
    {
        type: 'heading',
        depth: 1,
    ...
    },
    {
        type: 'heading',
        depth: 2,
        text: `${exports.sectionNameMock}:`,
    }
];
exports.parseStringMock = `DIP#: ${exports.dipNumber_1}`;
exports.openIssuemock = faker.random.word();
exports.components = [
    {
        cBody: "Defines several concepts that are important for understanding the DIPs process.",
        cName: `DIP${exports.dipNumber_1}c1`,
    ...
    },
    {
        ...
        cName: `DIP${exports.dipNumber_1}c10`,
    ...
    },
    {
        ...
        cName: `DIP${exports.dipNumber_1}c11`,
    ...
    },
    {
        ...
        cName: `DIP${exports.dipNumber_1}c12`,
    ...
    },
    {
        ...
        cName: `DIP${exports.dipNumber_1}c13`,
        cTitle: "Core Personnel Offboarding"
    }
];
exports.componentSummary = `**DIP${exports.dipNumber_1}c1: Definitions of the Maker Improvement Proposal Framework**  \n` +
    `Defines several concepts that are important for understanding the DIPs process.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c2: Core Principles**  \n` +
    `Discusses some core principles that all DIPs should aim to follow.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c3: The DIP Lifecycle**  \n` +
    `Lays out how a DIP is created and moves through the process to become Accepted or Rejected.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c4: DIP Components and DIP Component Types**  \n` +
    `Discusses the use of components to compartmentalize and organise DIPs\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c5: DIP Replacement Process**  \n` +
    `Discusses how DIPs can be replaced and the steps to be taken to maintain dependencies.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c6: Supporting Materials**\n` +
    `A component that defines how to include external materials inside DIPs.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c7: DIP Templates**  \n` +
    `Defines the DIP templates for both General and Technical DIPs.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c8: DIP${exports.dipNumber_1} Domain Role Dependencies**  \n` +
    `Defines the core roles that the DIPs process requires to operate successfully.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c9: Core Personnel Role List**  \n` +
    `List of of personnel currently occupying core roles.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c10: DIP Editor Role**  \n` +
    `A component that defines the responsibilities, criteria and grounds for removal of the DIP Editor role.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c11: Governance Facilitator Role**  \n` +
    `A component that defines the responsibilities, criteria and grounds for removal of the Governance Facilitator role.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c12: Core Personnel Onboarding**  \n` +
    `A process component that defines the process to add personnel to the DIP Editor or Governance Facilitator roles.\n` +
    `\n` +
    `**DIP${exports.dipNumber_1}c13: Core Personnel Offboarding**  \n` +
    `A process component that defines the process to remove personnel from the DIP Editor or Governance Facilitator roles.\n` +
    `\n` +
    `\n`;
exports.dipFile = `# DIP${exports.dipNumber_1}: ${exports.titleMock}\n\n## Preamble` +
    `\n${"```"}\nDIP#: ${exports.dipNumber_1}\nTitle: ${exports.titleMock}\nAuthor(s)` +
    `: ${exports.authorMock[0]}, ${exports.authorMock[1]}\nForum URL: ${exports.forumLinkMock}\nTags: ${exports.tagsMock}\nContributors` +
    `: ${exports.contributorsMock}\nType: ${exports.typesMock}\nRatification Poll URL: ${exports.votingPortalLinkMock}\nStatus: ${exports.statusMock} \nDate Proposed: ${exports.dateProposedMock}` +
    `\nDate Ratified: ${exports.dateRatifiedMock}\nExtra: ${exports.extraMock}\nDependencies: ${exports.dependenciesMock}\nReplaces: ${exports.replacesMock}\n` +
    `${"```"}\n## References\n**[General-DIP-Template.md](General-DIP-Template.m` +
    `d)**  \n**[Technical-DIP-Template.md](Technical-DIP-Template.md)**  \n` +
    `**[DIP${exports.dipNumber_1}c12-Subproposal-Template.md](DIP${exports.dipNumber_1}c12-Subproposal-Template.md)**` +
    `  \n**[DIP${exports.dipNumber_1}c13-Subproposal-Template.md](DIP${exports.dipNumber_1}c13-Subproposal-Template.m` +
    `d)**  \n\n## Sentence Summary\n\n${sentenceSummary}\n\n## Paragraph Summary\n\n${exports.paragraphSummaryMock}\n\n## Compo` +
    `nent Summary ${exports.dipNumber_1}\n\n**DIP${exports.dipNumber_1}c1: Definitions of the Maker Improvement Proposa` +
    `l Framework**  \nDefines several concepts that are important for under` +
    `standing the DIPs process.\n\n**DIP${exports.dipNumber_1}c2: Core Principles**  \nDiscusses` +
    ` some core principles that all DIPs should aim to follow.\n\n**DIP${exports.dipNumber_1}c3:` +
    ` The DIP Lifecycle**  \nLays out how a DIP is created and moves throug` +
    `h the process to become Accepted or Rejected.\n\n**DIP${exports.dipNumber_1}c4: DIP Compone` +
    ...
    `described in DIP${exports.dipNumber_1}, the Maker Improvement Proposal Framework.\n\n\n## S` +
    `pecification / Proposal Details\n\n### DIP${exports.dipNumber_1}c1: Definitions of the Make` +
    ...
    `munity standards.\n-   **DIP${exports.dipNumber_1}:** The genesis DIP defining the DIPs fra` +
    ...
    `Subproposals are named in the following format: DIP${exports.dipNumber_1}-SP1 (where DIP${exports.dipNumber_1} i` +
    `s a Process DIP and DIP${exports.dipNumber_1}-SP1 is a subproposal under that Process DIP) ` +
    ...
    `rocess components.\n   \n**Special Template:** N/A  \n  \n---\n\n### M` +
    `IP${exports.dipNumber_1}c5: DIP Replacement Process\n\nA DIP can define one or more replace` +
    ...
    `ce this DIP moves to Accepted status.\n---    \n\n### DIP${exports.dipNumber_1}c8: DIP${exports.dipNumber_1} Dom` +
    ...
    `authority of the DIP Editor(s) in DIP${exports.dipNumber_1} processes:**\n\t-   The DIP Edi` +
    ...
    `as described in DIP${exports.dipNumber_1}c4 “The DIP Lifecycle”.\n-   **Governance Facilita` +
    ...
    ` cycle).\n\nPersonnel may be added to these roles using a DIP${exports.dipNumber_1}c10 sub-` +
    `proposal.\nPersonnel may be removed from these roles using a DIP${exports.dipNumber_1}c11 s` +
    `ub-proposal.\n\n---\n### DIP${exports.dipNumber_1}c9: Core Personnel Role List \n\nThis lis` +
    `t can be amended through the core personnel onboarding (DIP${exports.dipNumber_1}c12) and ` +
    `offboarding components (DIP${exports.dipNumber_1}c13) of DIP${exports.dipNumber_1}.\n\nEntries into this list sh` +
    `ould follow the following template:\n\n${"```"}\n- Person Name: The name of` +
    ` the person in the core role.\n\t- Sub-proposal Number (DIP${exports.dipNumber_1}c12-SP): #` +
    ...
    `ard Brown\n    - **Sub-proposal Number (DIP${exports.dipNumber_1}c12-SP):** N/A (Governance` +
    ...
    `** 2020-05-28 [Ratification Vote: Officially Ratify the DIP${exports.dipNumber_1}c12-SP2 Su` +
    ...
    `roposal Number (DIP${exports.dipNumber_1}c12-SP):** 1\n\t- **Core Role:** DIP Editor\n\t- *` +
    ...
    `hannels:**\n\n-   Github\n-   RocketChat\n-   Forums\n\n---\n\n### DIP` +
    `${exports.dipNumber_1}c11: Governance Facilitator Role\n\n**Responsibilities**\n\nThe Gover` +
    ...
    ` RocketChat\n-   Forums\n\n---\n\n### DIP${exports.dipNumber_1}c12: Core Personnel Onboard` +
    `ing\n\nDIP${exports.dipNumber_1}c12 is a Process DIP component that allows the onboarding ` +
    `of core personnel using a subproposal. DIP${exports.dipNumber_1}c12 subproposals have the ` +
    `following parameters:\n-   **Feedback Period**: 3 months\n-   **Froze` +
    `n Period**: 1 month\n\nDIP${exports.dipNumber_1}c12 subproposals must use the template loc` +
    `ated at  **[DIP${exports.dipNumber_1}c12-Subproposal-Template.md](DIP${exports.dipNumber_1}c12-Subproposal-Temp` +
    `late.md)**. This template is considered ratified once this DIP moves ` +
    `to Accepted status.\n\n---\n\n### DIP${exports.dipNumber_1}c13: Core Personnel Offboarding` +
    `\n\nDIP${exports.dipNumber_1}c13 is a Process DIP component that allows the removal of cor` +
    `e personnel using a subproposal. DIP${exports.dipNumber_1}c13 subproposals have the follow` +
    `ing parameters:\n\n-   **Feedback Period**: 0 days\n-   **Frozen Peri` +
    `od**: 0 days\n\nDIP${exports.dipNumber_1}c13 subproposals must use the template located at` +
    `  **[DIP${exports.dipNumber_1}c13-Subproposal-Template.md](DIP${exports.dipNumber_1}c13-Subproposal-Template.md` +
    `)**. This template is considered ratified once this DIP moves to Acce` +
    `pted status.\n\n---`;
exports.dipData = {
    hash: faker.lorem.paragraph(),
    file: `# DIP${exports.dipNumber_1}: ${exports.titleMock}\n` +
        `\n` +
        `## Preamble\n` +
        `${"```"}\n` +
        `DIP#: ${exports.dipNumber_1}\n` +
        `Title: ${exports.titleMock}\n` +
        `Author(s): ${exports.authorMock[0]}, ${exports.authorMock[1]}\n` +
        `Forum URL: ${exports.forumLinkMock}\n` +
        `Tags: ${exports.tagsMock}` +
        `Contributors: ${exports.contributorsMock}\n` +
        `Type: ${exports.typesMock}\n` +
        `Ratification Poll URL: ${exports.votingPortalLinkMock}\n` +
        `Status: ${exports.statusMock} \n` +
        `Date Proposed: ${exports.dateProposedMock}\n` +
        ...
        `${exports.paragraphSummaryMock}\n` +
        `\n` +
        `## Component Summary ${exports.dipNumber_1}\n` +
        `\n` +
        `**DIP${exports.dipNumber_1}c1: Definitions of the Maker Improvement Proposal Framework**  \n` +
        `Defines several concepts that are important for understanding the DIPs process.\n` +
        `\n` +
        `**DIP${exports.dipNumber_1}c2: Core Principles**  \n` +
        `Discusses some core principles that all DIPs should aim to follow.\n` +
        ...
        `\n` +
        `In order for DIPs to be functional they need to comply with a basic standard outlining their internal structure and external dependencies. This standard is DIPs described in DIP${exports.dipNumber_1}, the Maker Improvement Proposal Framework.\n` +
        `\n` +
        `\n` +
        ...
        `-   **DIP${exports.dipNumber_1}:** The genesis DIP defining the DIPs framework. This DIP defines all of the processes that are required for the implementation of future DIPs. \n` +
        ...
        `-   **Subproposals (SPs):** A subproposal is an instance of a sub-process that has been defined by a specific DIP. Subproposals are named in the following format: DIP${exports.dipNumber_1}-SP1 (where DIP${exports.dipNumber_1} is a Process DIP and DIP${exports.dipNumber_1}-SP1 is a subproposal under that Process DIP)  \n` +
        ...
        `-   **Specific authority of the DIP Editor(s) in DIP${exports.dipNumber_1} processes:**\n` +
        `\t-   The DIP Editor(s) controls phase 2 of the DIP lifecycle and can assign DIP numbers\n` +
        `\t-   The DIP Editor(s) is an admin on the DIPs Github repository\n` +
        `\t-   The DIP Editor(s) is a moderator on the DIPs Discourse forum\n` +
        `\t-   The DIP Editor(s) is responsible for updating the status of DIPs, as described in DIP${exports.dipNumber_1}c4 “The DIP Lifecycle”.\n` +
        ...
        `-   **Specific authority of the Governance Facilitator in DIP${exports.dipNumber_1} processes:**\n` +
        `\n` +
        ...
        `\n` +
        `Personnel may be added to these roles using a DIP${exports.dipNumber_1}c10 sub-proposal.\n` +
        `Personnel may be removed from these roles using a DIP${exports.dipNumber_1}c11 sub-proposal.\n` +
        `\n` +
        `---\n` +
        `### DIP${exports.dipNumber_1}c9: Core Personnel Role List \n` +
        `\n` +
        `This list can be amended through the core personnel onboarding (DIP${exports.dipNumber_1}c12) and offboarding components (DIP${exports.dipNumber_1}c13) of DIP${exports.dipNumber_1}.\n` +
        `\n` +
        ...
        `    - **Sub-proposal Number (DIP${exports.dipNumber_1}c12-SP):** N/A (Governance Facilitator was ratified prior to the DIPs process. Reference: [Mandate: Interim Governance Facilitators](https://forum.makerdao.com/t/mandate-interim-governance-facilitators/264))\n` +
        `    - **Core Role:** Governance Facilitator\n` +
        ...
        `    - **Sub-proposal Number (DIP${exports.dipNumber_1}c12-SP):** 2\n` +
        `    - **Core Role:** Governance Facilitator\n` +
        `    - **Date Added:** 2020-05-28 [Ratification Vote: Officially Ratify the DIP${exports.dipNumber_1}c12-SP2 Subproposal for Onboarding a Second Governance Facilitator](https://mkrgov.science/executive/0x9713187b6d7c8d54ac041efdbac13d52c2120fb9)\n` +
        `\n` +
        `2. **DIP Editors:**\n` +
        `\n` +
        `-  **Person Name:** Charles St.Louis\n` +
        `\t- **Sub-proposal Number (DIP${exports.dipNumber_1}c12-SP):** 1\n` +
        `\t- **Core Role:** DIP Editor\n` +
        ...
        `### DIP${exports.dipNumber_1}c12: Core Personnel Onboarding\n` +
        `\n` +
        `DIP${exports.dipNumber_1}c12 is a Process DIP component that allows the onboarding of core personnel using a subproposal. DIP${exports.dipNumber_1}c12 subproposals have the following parameters:\n` +
        `-   **Feedback Period**: 3 months\n` +
        `-   **Frozen Period**: 1 month\n` +
        `\n` +
        `DIP${exports.dipNumber_1}c12 subproposals must use the template located at  **[DIP${exports.dipNumber_1}c12-Subproposal-Template.md](DIP${exports.dipNumber_1}c12-Subproposal-Template.md)**. This template is considered ratified once this DIP moves to Accepted status.\n` +
        `\n` +
        `---\n` +
        `\n` +
        `### DIP${exports.dipNumber_1}c13: Core Personnel Offboarding\n` +
        `\n` +
        `DIP${exports.dipNumber_1}c13 is a Process DIP component that allows the removal of core personnel using a subproposal. DIP${exports.dipNumber_1}c13 subproposals have the following parameters:\n` +
        `\n` +
        `-   **Feedback Period**: 0 days\n` +
        `-   **Frozen Period**: 0 days\n` +
        `\n` +
        `DIP${exports.dipNumber_1}c13 subproposals must use the template located at  **[DIP${exports.dipNumber_1}c13-Subproposal-Template.md](DIP${exports.dipNumber_1}c13-Subproposal-Template.md)**. This template is considered ratified once this DIP moves to Accepted status.\n` +
        `\n` +
        `---`,
    filename,
    sentenceSummary,
    paragraphSummary: exports.paragraphSummaryMock,
    author: exports.authorMock,
    contributors: exports.contributorsMock,
    dateProposed: exports.dateProposedMock,
    dateRatified: exports.dateRatifiedMock,
    dependencies: exports.dependenciesMock,
    dip,
    replaces: exports.replacesMock,
    status: exports.statusMock,
    title: exports.titleMock,
    types: exports.typesMock,
    votingPortalLink: exports.votingPortalLinkMock,
    forumLink: exports.forumLinkMock,
    tags: [exports.tagsMock],
};
exports.preambleMock = Object.assign(Object.assign({}, exports.dipData), { dipName: faker.random.word() });
exports.errorUpdateMock = faker.random.words();
exports.dipData_2 = Object.assign(Object.assign({}, exports.dipData), { dip: 1, filename: `DIP${exports.dipNumber_2}/dip${exports.dipNumber_2}.md`, sentenceSummary: `DIP${exports.dipNumber_2} ${faker.lorem.words(5)}`, title: `${faker.lorem.words(5)} v2`, references: [], proposal: `DIP${exports.dipNumber_2}`, subproposal: -1, tags: [faker.random.word()], status: faker.random.arrayElement(['Accepted', 'Rejected', 'RFC']), extra: [], language: dips_entity_1.Language.English, dipFather: false, components: [], sectionsRaw: [`DIP${exports.dipNumber_2}`] });
exports.tagResultMock = {
    tag: exports.dipData.tags[0],
};
exports.statusResultMock = {
    status: exports.dipData_2.status,
};
exports.smartSearchFieldMock = faker.random.word();
exports.markedMock = faker.random.word();
exports.markedLexerMock = [{
        type: faker.random.word(),
        value: faker.random.word(),
    }];
exports.requestGraphql = faker.random.word();
exports.pullRequestsMock = {
    definitions: [],
    kind: faker.random.word(),
};
exports.openIssueTitleMock = faker.random.word();
exports.openIssueBodyMock = faker.random.word();
exports.dipFilesMapMock = new Map();
exports.dipFilesMapMock.set(exports.dipData.filename, exports.dipData);
